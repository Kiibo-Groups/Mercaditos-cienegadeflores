...
@extends('layouts.app')
@section('title') Listado de Comercios  @endsection
            ...
            <div class="card">
                <div class="card-body table-responsive">
                    <p class="text-muted font-14 mb-3" style="position: relative;height: 50px;">
                        <a href="{{ Asset($link . 'create_commerce') }}" type="button" class="btn btn-success waves-effect waves-light" style="float: left;">
                            <span class="btn-label"><i class="mdi mdi-check-all"></i></span>Agregar elemento
                        </a>
                        <a href="{{ route('ImportComercios') }}" type="button" class="btn btn-info waves-effect waves-light" style="float: right;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button"
                                                ...
                                                onclick="confirmAlert('{{ Asset($link . 'status_commerce/' . $row->id) }}')">Activo</button>
                                        @else
                                            <button type="button"
                                                class="btn btn-danger width-xs waves-effect waves-light"
                                                onclick="confirmAlert('{{ Asset($link . 'status_commerce/' . $row->id) }}')">Inactivo</button>
                                        @endif
                                    </td>
                                    <td width="17%" style="text-align: right">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu p-3 text-muted" style="max-width: 200px;">
                                                <a href="{{ Asset($link . $row->id . '/edit_commerce') }}"
                                                    class="dropdown-item"
                                                ...
                                                <a type="button" class="dropdown-item"
                                                    onclick="deleteConfirm('{{ Asset($link . 'delete_commerce/' . $row->id) }}')">
                                                    Eliminar</a> 
                                            </div>
                                        </div>
